...
def create_parser():
    ...
    parser.add_argument(
        '--word2vec_model_path', '-word2vec_model_path', type=str, default="../word2vec_model/IMDB_fasttext_skipgram.vec",
        metavar='PATH',
...
def My_main():
    ...
    with tf.name_scope('Model'):
        myLSTM_outputs, my_variables_value = LSTM_class.dynamic_bidirectional_LSTM(input_x, FLAGS.embedding_dim,
                                                                                   seq_max_len,
...
if __name__ == "__main__":
    ...
    if FLAGS.is_evaluation:
        ...
        import visualize
        visualize.list_plot(train_acc_list, test_acc_list)
        visualize.list_plot(train_loss_list, test_loss_list)
