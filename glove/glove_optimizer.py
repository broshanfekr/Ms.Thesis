...
class GloVeModel():
    ...
    def fit_to_corpus(self, corpus):
        ...
        self.vocab_size = len(self.__words)
        self.__build_graph()
    ...
    def __build_graph(self):
        ...
        with self.__graph.as_default():
            ...
            focal_embeddings = tf.Variable(
                tf.random_uniform([self.vocab_size, self.embedding_size], 1.0, -1.0), name="focal_embeddings")
            ...
            weighting_factor = tf.minimum(1.0, tf.pow(tf.div(self.__cooccurrence_count, count_max), scaling_factor))
    ...
    def __prepare_batches(self):
        cooccurrences = [(word_ids[0], word_ids[1], count) for word_ids, count in self.__cooccurrence_matrix.items()]
    ...
    def generate_tsne(self, path=None, size=(50, 50), word_count=1000, embeddings=None):
