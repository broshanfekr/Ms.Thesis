...
def create_parser():
    ...
    parser.add_argument(
        '--input_dataset_path', '-input_dataset_path', type=str, default="input_data/rt_dataset.txt",
        metavar='PATH',
        help="Path of the dataset"
    )
    parser.add_argument(
        '--word2vec_model_path', '-word2vec_model_path', type=str, default="word2vec_model/rt_skipgram_model",
        metavar='PATH',
    ...
    parser.add_argument(
        '--evaluate_every', '-evaluate_every', type=int, default=5,
        help="Evaluate model on dev set after this many steps"
    )
    parser.add_argument(
        '--checkpoint_every', '-checkpoint_every', type=int, default=5,
        help="Save model after this many steps"
    )
    parser.add_argument(
        '--l2_reg_lambda', '-l2_reg_lambda', type=float, default=0.00001,
